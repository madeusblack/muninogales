  ...
  'news': [
    {
      ...
      'etiquetas': ['Intendente de Valparaíso, Jorge Martínez Durán', 'Alcaldesa Nogales, Margarita Osorio Pizarro', 'Diputada, Camila Flores Oporto', 'Consejero Regional, Manuel Murillo Calderón', 'Consejero Regional, Percy Marín Vera'],
      'audios': ['aljibesIntendente', 'aljibesAlcaldesa', 'aljibesCamila', 'aljibesCore', 'aljibesPercy'],
    },
    {
      'id': 2,
